...
<Tabs>
    ...
    <Tab title="HttpClient">
        ...
        **HttpClient: Customizing HTTP requests**
        ...
        To dynamically modify HTTP requests before they are issued, implement either `McpSyncHttpClientRequestCustomizer` or `McpAsyncHttpClientRequestCustomizer`.
    ...
    <Tab title="WebClient">
        ...
        **WebClient: Customizing HTTP requests**
        ...
        To dynamically modify HTTP requests, the builder has a dedicated API, `ExchangeFilterFunction`.
